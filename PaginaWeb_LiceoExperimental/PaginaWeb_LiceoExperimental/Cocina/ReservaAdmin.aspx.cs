...
{
    public partial class ReservaAdmin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!logica.VerificarPlatoDia() && logica.ConsultarPlatoDia() > 0)//Determina si ya hay un almuerzo del dia
            {
        ...
        protected void Reservar_Click(object sender, EventArgs e)
        {
            ...
            if (logica.VerificarHora())//Verifica que se pueda reservar a esta hora
            {
                ...
                string s = logica.ReservarAdmin(long.Parse(Session["PersonaID"]+""));//reserva Admin
