<%@ Page Title="" Language="C#" MasterPageFile="~/Noticias/NavNoticias.Master" AutoEventWireup="true" CodeBehind="AdministrarNoticias.aspx.cs" Inherits="PaginaWeb_LiceoExperimental.Noticias.AdministrarNoticias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="max-width: 100%">
        <div class="row g-4" style="max-width: 150%" >
            <div class="col-md-12 " style="width: 200rem">
                <br />
                <br />
                <h3 style="text-align: center;">Lista de Noticias</h3>
                <br />
                ...
                <form id="formulario" class="form-horizontal card" runat="server" style="background-size: 20% 20%; width: 200rem;">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" runat="server" class="form-control" id="buscar_txt" placeholder="Buscar título de noticia" maxlength="200" />
                            <br />
                        </div>
    ...
    <script>
       var myTour = {
           ...
           steps: [
               {
                   title: "Lista de noticas",
                   content: "En esta sección puedes administrar las noticas publicadas por la institución",
                ...
                },
                {
                    ...
                    content: "En este espacio se puede ingresar el nombre de la noticias y así realizar su busqueda",
                ...
                },
                {
                    ...
                    content: "Este botón abre un apartado el cual permite ingresar una nueva noticia por parte de la institución",
                ...
                },
                {
                    ...
                    content: "En caso de querer realizar más acciones con las noticias, se puede presionar el botón de modificar la noticia y el de eliminarla",
