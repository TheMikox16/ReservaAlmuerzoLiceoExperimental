...
namespace PaginaWeb_LiceoExperimental.Profes
{
    ...
    */
    ...
    public partial class AdministrarSecciones : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (v != null && v.Equals("1"))
            {
                ...
                Session["ver"] = 0;
                Session["insertar"] = 0;
                Response.Redirect("FormularioSeccion.aspx");
            }
            else if (v != null && v.Equals("2"))
            {
                ...
                Session["ver"] = 0;
                Session["insertar"] = 0;
                string s = logica.EliminarSeccion(Int32.Parse(Request.QueryString["SId"] + ""));
        ...
        public string DataGridCreation()
        {
            ...
            {
                list = logica.ListarSeccionesDesc(buscar_txt.Value);
            }
            else
            {
            ...
            foreach (DataRow myRow in table.Rows)
            {
                ...
                foreach (DataColumn myColumn in table.Columns)
                {
                    ...
                    if (myColumn.ColumnName.Equals("Modificar"))
                    {
                        strHTMLBuilder.Append("<td >");
                        temp2 = (int)list[i][0];
                        strHTMLBuilder.Append("<a ID=\"mod\" type=\"button\" runat=\"server\" class=\"btn btn-secondary\" href=\"?SId=" + temp2 + "&ver=1\">Modificar</a>");
                    ...
                    else if (myColumn.ColumnName.Equals("Eliminar"))
                    {
                        strHTMLBuilder.Append("<td >");
                        temp2 = (int)list[i][0];
                        strHTMLBuilder.Append("<a ID=\"el\" type=\"button\" runat=\"server\" class=\"btn btn-danger\" href=\"?SId=" + temp2 + "&ver=2\" onclick=\"return confirm('¿Realmente desea borrar esta sección?')\">Eliminar</a>");
