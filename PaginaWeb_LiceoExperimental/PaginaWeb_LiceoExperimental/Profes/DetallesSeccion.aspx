<%@ Page Title="" Language="C#" MasterPageFile="~/Profes/NavProfesores.Master" AutoEventWireup="true" CodeBehind="DetallesSeccion.aspx.cs" Inherits="PaginaWeb_LiceoExperimental.Profes.DetallesSeccion" %>
    ...
    <div class="container" style="max-width: 100%">
        <div class="row g-4" style="max-width: 150%" >
            <div class="col-md-12 " style="width: 200rem">
                ...
                <h4 runat="server" id="seccion_lbl" style="text-align: center;"></h4>
