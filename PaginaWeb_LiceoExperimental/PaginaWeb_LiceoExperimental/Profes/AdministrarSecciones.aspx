<%@ Page Title="" Language="C#" MasterPageFile="~/Profes/NavProfesores.Master" AutoEventWireup="true" CodeBehind="AdministrarSecciones.aspx.cs" Inherits="PaginaWeb_LiceoExperimental.Profes.AdministrarSecciones" %>
     ...
     <div class="container" style="max-width: 100%">
        <div class="row g-4" style="max-width: 150%" >
            <div class="col-md-12 " style="width: 200rem">
                <br />
                <br />
                <h3 style="text-align: center;">Lista de Secciones</h3>
                <br />
                ...
                <form id="formulario" class="form-horizontal card" runat="server" style="background-size: 20% 20%; width: 200rem;">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" runat="server" class="form-control" id="buscar_txt" placeholder="Buscar sigla de sección" maxlength="5" />
                            <br />
                        </div>
           ...
           steps: [
               {
                ...
                },
                {
                    ...
                    content: "En este espacio se puede ingresar el numero de sección para realizar su posterior busqueda",
                ...
                },
                {
                    ...
                    content: "Este botón efectua la busqueda de la sección que se ingreso en el espacio a la par",
                ...
                },
                {
                    ...
                    content: "Este botón abre un apartado el cual permite ingresar una nueva sección por parte de la institución",
                ...
                },
                {
                    ...
                    content: "En caso de querer realizar más acciones con las secciones, se puede presionar el botón de modificar la sección y su profesor asignado y el de eliminarla de ser el caso",
